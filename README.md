...
A digital asset price aggregator, the app centralizes real-time prices retrieval from over 54 exchanges using Websocket APIs and distributes them via websocket in a single, simple format.
